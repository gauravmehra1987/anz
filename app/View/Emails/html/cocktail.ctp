...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
  ...
  <tr>
    <td align="left" valign="top" style="color:#414042; font-size:14px; font-family:Verdana, Geneva, sans-serif; padding-left:40px;">Dear <?php echo $form['Cocktail']['first_name']; ?> <?php echo $form['Cocktail']['last_name']; ?>, </td>
  </tr>
  <tr>
